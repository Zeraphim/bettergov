...
- `summary.json`: Precomputed totals for the dashboard (total projects, total cost, unique contractors)
...
- The same script also generates `lookups/summary.json` with overall totals for the dashboard
